...
Так, в слое **presentation** необходимо разместить код, который будет организорвывать логику отображения на экране пользователя и ввод пользовательских данных. То есть здесь должно быть отражено взаимодействие с компонентами библиотеки dotnet-curses и Domain-уровнем. 
...
Реализуй с curses рендеринг игры в **presentaion** слое, используя необходимые сущности **domain**.
